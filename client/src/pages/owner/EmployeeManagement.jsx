                            ...
                            >
                                ...
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-slate-400 text-sm truncate">{employee.username}</p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3 mb-5">
                                    ...
                                    <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                                        <div className="flex items-center gap-3 overflow-hidden">
                                            <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-slate-400 shadow-sm flex-shrink-0">
                                        ...
                                        {employee.email && employee.id !== user.id && (
                                            <button
                                                onClick={(e) => handleSendWelcomeEmail(employee, e)}
                                                className="p-2 bg-white text-green-600 rounded-lg shadow-sm hover:bg-green-50 transition-colors"
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        <div className="p-3 bg-slate-50 rounded-xl flex items-center gap-3">
                                            <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-green-500 shadow-sm flex-shrink-0">
                                ...
                                {employee.id !== user.id && (
                                    <div className="flex items-center gap-2 pt-4 border-t border-slate-100">
                                        <button
                                            ...
                                            className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-slate-50 text-slate-600 font-medium text-sm hover:bg-slate-100 transition-colors"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-blue-50 text-blue-600 font-medium text-sm hover:bg-blue-100 transition-colors"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-red-50 text-red-600 font-medium text-sm hover:bg-red-100 transition-colors"
                                        >
