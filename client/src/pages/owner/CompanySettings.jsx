                        ...
                        <div className="bg-white rounded-[2.5rem] shadow-sm p-8 mb-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 mt-6">
                                <button
                                    ...
                                    className="w-full sm:w-auto px-6 py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                >
                                    {testingEmail ? (
                                        <>
                                ...
                                <button
                                    ...
                                    className="w-full sm:w-auto px-6 py-3 bg-slate-900 text-white font-semibold rounded-xl hover:bg-slate-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                >
