        ...
        <Layout title="Registro Presenze">
                                ...
                                >
                                    ...
                                    <div className="p-5 pb-4">
                                        <div className="flex items-center justify-between">
                                            ...
                                            {isCompleted ? (
                                                <div className="flex items-center gap-1 bg-slate-100 text-slate-600 px-2.5 py-1 rounded-full text-xs font-semibold">
                                                    <Clock className="w-3 h-3" />
                                                    {calculateDuration(attendance.clockIn, attendance.clockOut)}
                                                </div>
                                            ) : (
                                                <div className="flex items-center gap-1 border-2 border-green-500 text-green-600 px-2.5 py-1 rounded-full text-[10px] font-bold">
                                    ...
                                    <div className="px-5 pb-5 pt-3 flex items-center justify-between border-t border-slate-50">
                                        <div className="flex items-center gap-4">
                                            {/* ENTRATA */}
                                            <div>
                                                <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Entrata</div>
                                                <div className="flex items-center gap-1.5">
                                                    <span className="font-bold text-slate-900 text-base">{formatTime(clockInTime)}</span>
                                            ...
                                            {/* USCITA */}
                                            <div>
                                                <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Uscita</div>
                                                <div className="flex items-center gap-1.5">
                                                    {isCompleted ? (
                                                        <>
                                                            <span className="font-bold text-slate-900 text-base">{formatTime(clockOutTime)}</span>
                                                            <MapPin className="w-3 h-3 text-orange-500" />
                                                        </>
                                                    ) : (
                                                        <span className="font-bold text-slate-400 text-base tracking-widest">--:--</span>
                                                    )}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center gap-4">
                                            <div className="text-right">
                                                <div className="text-[10px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Data</div>
                                                <div className="font-bold text-slate-900 text-sm">{formatDate(clockInTime)}</div>
                                            </div>
            ...
            {selectedAttendance && (
                <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
                    ...
                    {/* Sheet */}
                    <div className="relative bg-white rounded-t-3xl sm:rounded-[2.5rem] w-full max-w-md mx-auto max-h-[85vh] overflow-y-auto shadow-2xl animate-in slide-in-from-bottom duration-300">
                        {/* Header */}
